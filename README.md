**This charm is under maintenance mode-only since 2026/01/01. It means that only security issues will be addressed, no new features will be implemented on the charm. Users are invited to look at https://charmhub.io/gateway-api-integrator to address their ingress needs on Kubernetes.**
