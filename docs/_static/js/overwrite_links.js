...
const oldDomain = 'canonical-nginx-ingress-integrator-juju-charm.readthedocs-hosted.com';
const newDomain = 'canonical.com/juju/docs/nginx-ingress-integrator-charm';
