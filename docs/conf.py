...
project = "NGINX ingress integrator charm"
...
ogp_site_url = f"https://canonical.com/juju/docs/nginx-ingress-integrator-charm/{version}/"
...
html_context = {
    ...
    "product_page": "charmhub.io/nginx-ingress-integrator",
    ...
    "github_url": "https://github.com/canonical/nginx-ingress-integrator-operator",
...
#
html_theme_options = {
    'source_edit_link': 'https://github.com/canonical/nginx-ingress-integrator-operator',
}
...
slug = 'juju/docs/nginx-ingress-integrator-charm'
...
html_baseurl = f"https://canonical.com/juju/docs/nginx-ingress-integrator-charm/{version}/"
